...
CREATE TABLE `sky_mod_b2c_category` (
  ...
  PRIMARY KEY (`catid`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='分类';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='优惠券用户';
...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COMMENT='产品聚合';
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COMMENT='订单';
...
CREATE TABLE `sky_mod_b2c_order_raty` (
  ...
  KEY `orderid` (`orderid`) USING BTREE,
  KEY `userid` (`userid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='订单评价';
CREATE TABLE `sky_mod_b2c_pintuan_item` (
  ...
  KEY `productid` (`productid`) USING BTREE,
  KEY `userid` (`userid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='拼团团购';
...
) ENGINE=InnoDB AUTO_INCREMENT=163 DEFAULT CHARSET=utf8mb4 COMMENT='产品';
