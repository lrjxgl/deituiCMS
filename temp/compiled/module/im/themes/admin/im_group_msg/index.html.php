...
<tr>
   ...
   <td><?php echo $this->_var['c']['group_title']; ?></td>
   <td><?php echo $this->_var['c']['nickname']; ?></td>
    
   <td><?php echo date("Y-m-d",$this->_var['c']['dateline']); ?></td>
   
   <td><?php echo $this->_var['c']['content']; ?></td>
<td> <div class="btn-mini js-forbid-post" userid="<?php echo $this->_var['c']['userid']; ?>">禁言</div>
<div class="btn-mini js-join-blacklist"  userid="<?php echo $this->_var['c']['userid']; ?>">拉黑</div>
<a href="javascript:;" class="btn-mini btn-danger js-delete" url="/moduleadmin.php?m=im_group_msg&a=delete&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
