...
<html>
	...
	<body>
<?php echo $this->fetch('gread_shop/nav.html'); ?>
 <table class="tbs">
<thead>  <tr>
   <td>shopid</td>
   <td>店名</td>
...
<td><a href="/module.php?m=gread_shop&a=add&shopid=<?php echo $this->_var['c']['shopid']; ?>">编辑</a> <a href="/module.php?m=gread_shop&a=show&shopid=<?php echo $this->_var['c']['shopid']; ?>">查看</a> <a href="javascript:;" class="delete" url="/module.php?m=gread_shop&a=delete&shopid=<?php echo $this->_var['c']['shopid']; ?>">删除</a></td>
  </tr>
