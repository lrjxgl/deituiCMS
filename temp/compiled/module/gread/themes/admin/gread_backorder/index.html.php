...
<html>
	...
	<body>
<?php echo $this->fetch('gread_backorder/nav.html'); ?>
 <table class="tbs">
<thead>  <tr>
   <td>orderid</td>
   <td>userid</td>
...
<td><a href="/module.php?m=gread_backorder&a=add&orderid=<?php echo $this->_var['c']['orderid']; ?>">编辑</a> <a href="/module.php?m=gread_backorder&a=show&orderid=<?php echo $this->_var['c']['orderid']; ?>">查看</a> <a href="javascript:;" class="delete" url="/module.php?m=gread_backorder&a=delete&orderid=<?php echo $this->_var['c']['orderid']; ?>">删除</a></td>
  </tr>
