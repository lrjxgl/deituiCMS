...
<tr>
   ...
   <td><?php if ($this->_var['c']['status'] == 2): ?>
          ...
          <?php endif; ?></td>
<td><a href="admin.php?m=dataapi&a=add&id=<?php echo $this->_var['c']['id']; ?>">编辑</a> <a href="admin.php?m=dataapi&a=show&id=<?php echo $this->_var['c']['id']; ?>">查看</a> <a href="javascript:;" class="delete" url="admin.php?m=dataapi&a=delete&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
