...
<td><a href="admin.php?m=open_qq&a=add&id=<?php echo $this->_var['c']['id']; ?>">编辑</a> <a href="admin.php?m=open_qq&a=show&id=<?php echo $this->_var['c']['id']; ?>">查看</a> <a href="javascript:;" class="delete" url="admin.php?m=open_qq&a=delete&ajax=1&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
