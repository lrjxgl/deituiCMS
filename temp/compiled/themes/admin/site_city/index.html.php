...
<td><a href="admin.php?m=site_city&a=add&sc_id=<?php echo $this->_var['c']['sc_id']; ?>">编辑</a> <a href="admin.php?m=site_city&pid=<?php echo $this->_var['c']['sc_id']; ?>">下级区域</a> <a href="javascript:;" class="delete" url="admin.php?m=site_city&a=delete&sc_id=<?php echo $this->_var['c']['sc_id']; ?>">删除</a></td>
  </tr>
