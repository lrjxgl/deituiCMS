...
<div class="tabs-border">
	<a class="item active" href="<?php echo $this->_var['appadmin']; ?>?m=module">模块列表</a>
	<a class="item" href="http://www.deitui.com/index.php?m=yunmodule&product=deituicms">应用商店</a>
</div>
<div class="main-body">
<div class="search-form">
	下载秘钥 <input type="text" class="w150" id="downcode"> <div class="btn" id="yun_app_install">安装</div>
</div>
