...
?>
        ...
        <tr>
          <td>开始时间：</td>
          <td><input readonly="" type="text" name="starttime" id="starttime" value="<?php if ($this->_var['data']): ?><?php echo date("Y-m-d H:m:s",$this->_var['data']['starttime']); ?><?php endif; ?>" ></td>
        </tr>
        <tr>
          <td>结束时间：</td>
          <td><input readonly="" type="text" name="endtime" id="endtime" value="<?php if ($this->_var['data']): ?><?php echo date("Y-m-d H:m:s",$this->_var['data']['endtime']); ?><?php endif; ?>" ></td>
        </tr>
        <tr>
          <td>图片地址：</td>
          <td>
