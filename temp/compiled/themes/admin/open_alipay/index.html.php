...
<td><a href="admin.php?m=open_alipay&a=add&id=<?php echo $this->_var['c']['id']; ?>">编辑</a> 


<a href="javascript:;" class="js-delete" url="admin.php?m=open_alipay&a=delete&ajax=1&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
