...
<td><a href="admin.php?m=weixin&a=add&id=<?php echo $this->_var['c']['id']; ?>">编辑</a>
 ...
 <a href="admin.php?m=weixin&a=setWeixin&id=<?php echo $this->_var['c']['id']; ?>">进入管理</a> <a href="javascript:;" class="delete" url="admin.php?m=weixin&a=delete&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
