...
<html>
	...
	<body>
<?php echo $this->fetch('open_baidu/nav.html'); ?>
<div class="main-body">
 <table class="tbs">
<thead>  <tr>
   <td>id</td>
...
<td><a href="admin.php?m=open_baidu&a=add&id=<?php echo $this->_var['c']['id']; ?>">编辑</a> 


<a href="javascript:;" class="js-delete" url="admin.php?m=open_baidu&a=delete&ajax=1&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
