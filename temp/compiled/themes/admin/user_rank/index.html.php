...
<td><a href="admin.php?m=user_rank&a=add&id=<?php echo $this->_var['c']['id']; ?>">编辑</a> 
 
<a href="javascript:;" class="js-delete" url="admin.php?m=user_rank&a=delete&id=<?php echo $this->_var['c']['id']; ?>">删除</a></td>
  </tr>
